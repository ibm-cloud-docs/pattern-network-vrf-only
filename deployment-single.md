...
This architecture is deployable by terraform automation and can be accessed via [Github](https://github.com/IBM/ccs-patterns/tree/main/pattern-network-classic-single-zone){: external}.
{: note}
