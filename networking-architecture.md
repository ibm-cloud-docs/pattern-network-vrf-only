...
{: caption="Classic data center network enterprise connectivity architecture decisions"}
...
{: caption="Classic data center network BYOIP and edge gateway architecture decisions"}
...
{: caption="Classic data center network segmentation and isolation architecture decisions"}
...
{: caption="Classic data center network cloud native connectivity architecture decisions"}
...
{: caption="Classic data center network load-balancing architecture decisions"}
...
{: caption="Classic data center network Domain Name System architecture decisions"}
